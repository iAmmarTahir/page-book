    ...
    const handleSubmit = (e) => {
        ...
        .then((res) => {
            ...
            .then((res) => {
                ...
                props.user.setAuthenticated(true)
            })
            ...
            <form>
                <div className="row">
                    ...
                    <div className="col-md-4">
                        ...
                        <button style={{float: 'right'}}type="submit" className="btn btn-success" onClick={(e) => handleSubmit(e)}>Login</button>
                        <h6 onClick={()=> {props.history.push('/register')}}>Do not have an account? Register</h6>
                        {errors ? ( 
